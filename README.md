...
Este repositório é a camada de coleta de dados de um TCC que compara a qualidade de código C# gerado por diferentes LLMs, usando métricas como CodeBLEU, análise estática via SonarQube e testes de comportamento (xUnit) sobre os 84 projetos gerados.
